...
| C17 CycloneDX + obligations | ✅ **COMPLETE (internal verification)** at `376458d1…`, hosted run `31823318720` 3/3 green. Vendored official 1.6.2 schema closure (3 digests matching), offline strict-mode Ajv 8.18.0 validator, both SBOMs 0 errors, 60 C17 controls, linux CI inventory 195/195 + 296/296 with 0 unresolved and 0 reconciliation problems, separate empty legal-disposition document, deterministic artifacts. |
