...
| Phase 4 — Prediction + Scenario Intelligence | L6–L7 | **IMPLEMENTED — awaiting owner review (PR unmerged)** | Report: [PHASE4_REPORT.md](PHASE4_REPORT.md). Handoff: [PHASE4_PRODUCT_HANDOFF.md](PHASE4_PRODUCT_HANDOFF.md). Plan: [PHASE4_DATA_READINESS_PLAN.md](PHASE4_DATA_READINESS_PLAN.md) (T1–T4, D1–D8, the owner's four source decisions of 2026-09-05). Migrations 0028–0030. Closed-range backfill on the governed REST poller; ECB EUR/USD activated and backfilled live (28 windows, 1999-01-04 → today); series assembly through the known-at path, per reader and purpose, disclosing unreadable evidence; seasonal naive and Holt-Winters with the model on a leash bound to the APPLICABLE backtest; backtests in retrospective and historical knowledge modes; controls inherited evidence → forecast → scenario → warning; one warning per flip, owed until raised; replay timing with decision deadlines; outcomes never scored before the target. ECB at 30 days: T1 met (85%) and T2 NOT met (skill −1.6%) **retrospectively**; historically it cannot validate on a backfilled vintage. T3 unmeasured. The corridor forecast is a replay demonstration that cannot be validated and says so. One consolidated correction pass against the Codex review of 737ca81a (report §10). PortWatch stays in replay pending the IMF's answer; UN Comtrade untouched; nothing purchased. |
