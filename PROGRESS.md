...
| C19 docs + NOLOGIN roles | — | ⏳ (`eye_system` + legacy roles still LOGIN) — **status now reconciled**; see [PHASE0_ACCEPTANCE_RECONCILIATION.md](PHASE0_ACCEPTANCE_RECONCILIATION.md) |
...
* **Every merge in this history carries `reviews=0`.** The first publication reached the public
  transparency log before any independent review existed, and it is permanent.
* Phase 1 implementation (PR #28) was opened before this reconciliation was performed. PR #28 is
  unmerged and frozen.

The reconciled chronology, the immutable evidence, the process exception PEX-P0-001, the proposed
tag text and the separation between self-verification and independent evidence are in
