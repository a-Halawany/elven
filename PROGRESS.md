...
| Phase 1 — World Observation Layer | L1 | **PLAN PRESENTED — awaiting `APPROVED: PHASE 1`** | Plan: [PHASE1_PLAN.md](PHASE1_PLAN.md). Observation/Crawler/Collection agent contracts introduced here. |
