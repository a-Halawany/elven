...
| Phase 5 — Digital Twins + Simulation | L5, L8 | **PLANNED — awaiting owner approval** | Plan: [PHASE5_BUILD_PLAN.md](PHASE5_BUILD_PLAN.md) (E1–E8 and eight grounding rules to freeze; first stage P5-M1 defined). Dependency baseline: Phase 4 at PR #38 head 98e7d9e6. The roadmap names this phase Digital Twins + Simulation (L5, L8); the earlier row title followed the Phase 0 table, which numbered the layers differently. |
