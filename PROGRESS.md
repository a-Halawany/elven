...
| Phase 4 — Prediction & Scenario Intelligence | L6–L7 | **READINESS PLAN — awaiting owner decisions** | Plan: [PHASE4_DATA_READINESS_PLAN.md](PHASE4_DATA_READINESS_PLAN.md). No implementation started. Four decisions are open: PortWatch and ECB reuse terms, whether to activate the held UN Comtrade free-tier key, and confirmation that nothing is purchased. |
