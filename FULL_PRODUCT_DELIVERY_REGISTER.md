...
Reading the unit table: 3897 units decompose the 6264 rows (every row referenced). Mandatory units unfinished for full-profile acceptance: 3548 = 3195 in status open + 339 verified on the author's harness only + 14 verified on the hosted chain only (AU-PRD-0021 at `1a99784`; six of the seven CP-6 B1/B2 units at `5118376`, ci run 34647461349, 836/836 on a fresh database; AU-MEM-0109 set back to open at Codex's recovery finding, corrected by 0062 at `637233f` and verified again at `94d66f8`, ci run 34655152733; the six CP-6 B6 units AU-MEM-0112 to AU-MEM-0117 at `fcbdefc`, ci run 34663012651, 852/852 in 49 files on a fresh database, C19 34663012694). The total rose from 3,542 to 3,548 by the allocation of B6's six units, not by regression; no leg of any unit is accepted; nothing here is an acceptance.
