...
Reading the unit table: 3897 units decompose the 6264 rows (every row referenced). Mandatory units unfinished for full-profile acceptance: 3548 = 3201 in status open + 339 verified on the author's harness only + 8 verified on the hosted chain only (AU-PRD-0021 at `1a99784`; six of the seven CP-6 B1/B2 units at `5118376`, ci run 34647461349, 836/836 on a fresh database; AU-MEM-0109 set back to open at Codex's recovery finding and corrected by 0062 at `637233f`, hosted green at `94d66f8` (ci 34655152733), returned to verified:ci at that head). The six new units of CP-6 B6 (AU-MEM-0112 to AU-MEM-0117, the GraphChanged/MemoryCorrected subscriptions and their six consumers) are open until the hosted run at their implementing head is green — the total therefore rose from 3,542 to 3,548 by allocation, not by regression. No leg of any unit is accepted; nothing here is an acceptance.
