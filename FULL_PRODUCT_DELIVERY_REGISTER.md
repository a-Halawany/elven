...
Reading the unit table: 3901 units decompose the 6264 rows (every row referenced). Mandatory units unfinished for full-profile acceptance: 3552 = 3194 in status open + 341 verified on the author's harness only + 17 verified on the hosted chain only (AU-PRD-0021 at `1a99784`; six of the seven CP-6 B1/B2 units at `5118376`, ci run 34647461349; AU-MEM-0109 at `94d66f8`, ci run 34655152733; the six CP-6 B6 units AU-MEM-0112 to AU-MEM-0117 and AU-MEM-0029 at `fcbdefc`, ci run 34663012651; the two CP-6 B7 units AU-MEM-0118 and AU-MEM-0119 at `a852c65`, ci run 34693808238, 867/867 in 51 files on a fresh database, C19 34693808173). The total rose from 3,542 to 3,552 across B6, B7 and B8 by allocation of ten new units (B8: AU-DP-0175, ordered publication across ticks, lease recovery and processes with one server per domain; AU-MEM-0120, a replay reaching the retained history with the declared floor — both `verified:local` at the B8 head, 890/890 in 53 files on a fresh database, with AU-MEM-0039 moved from open to `verified:local` as its last two conditions gained fault cases), not by regression; AU-MEM-0041, AU-MEM-0114, AU-DP-0071, AU-DP-0041 and AU-MEM-0031 carry their delivered and remaining clauses in their own prose. No leg of any unit is accepted; nothing here is an acceptance.
