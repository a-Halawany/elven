...
let h: Phase4Harness;
let w: DecisionWorld;
let c: ReturnType<typeof decisionCalls>;
let decisions: DecisionWorld['decisions'];
let owner: AuthenticatedPrincipal; let approver: AuthenticatedPrincipal; let authority: AuthenticatedPrincipal; let executive: AuthenticatedPrincipal; let agent: AuthenticatedPrincipal; let operator: AuthenticatedPrincipal;
...
const declare: typeof c.declare = (...a) => c.declare(...a);
const open: typeof c.open = (...a) => c.open(...a);
const option: typeof c.option = (...a) => c.option(...a);
const terms: typeof c.terms = (...a) => c.terms(...a);
const choice: typeof c.choice = (...a) => c.choice(...a);
const propose: typeof c.propose = (...a) => c.propose(...a);
const dissent: typeof c.dissent = (...a) => c.dissent(...a);
const get: typeof c.get = (...a) => c.get(...a);
const validTerms: typeof c.validTerms = (over = {}) => c.validTerms(over);
const validChoice: typeof c.validChoice = (over = {}) => c.validChoice(over);
...
beforeAll(async () => {
  ...
  ({ owner, approver, authority, executive, agent, operator, controlId, rerouteId, airId, control2Id, objectiveId, decisionId, indicatorId, evd } = w);
}, 300_000);
